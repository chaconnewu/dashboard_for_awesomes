...
-   [Responders](https://github.com/plataformatec/responders) <span> ★ 1377, pushed 0 days ago </span> - A set of Rails responders to dry up your application.
...
-   [Action caching for Action Pack](https://github.com/rails/actionpack-action_caching) <span> ★ 95, pushed 34 days ago </span> - Action caching for Action Pack.
...
-   [AWS SDK for Ruby](https://github.com/aws/aws-sdk-ruby) <span> ★ 2015, pushed 0 days ago </span> - The official AWS SDK for Ruby.
...
-   [Scientist](https://github.com/github/scientist) <span> ★ 3461, pushed 11 days ago </span> - A Ruby library for carefully refactoring critical paths.
...
-   [SchemaPlus](https://github.com/SchemaPlus/schema_plus) <span> ★ 618, pushed 48 days ago </span> - SchemaPlus provides a collection of enhancements and extensions to ActiveRecord
...
-   [auto\_html](https://github.com/dejan/auto_html) <span> ★ 711, pushed 139 days ago </span> - Rails extension for transforming URLs to appropriate resource (image, link, YouTube, Vimeo video...)
...
-   [Squid](https://github.com/fullscreen/squid) <span> ★ 153, pushed 26 days ago </span> - Squid · A Ruby library to plot charts in PDF files
...
-   [ruby-prof](https://github.com/ruby-prof/ruby-prof) <span> ★ 1138, pushed 8 days ago </span> - A code profiler for MRI rubies.
...
-   [SciRuby](https://github.com/sciruby/sciruby) <span> ★ 738, pushed 8 days ago </span> - Tools for scientific computation in Ruby/Rails.
    ...
    -   [statsample-timeseries](https://github.com/sciruby/statsample-timeseries) <span> ★ 8, pushed 266 days ago </span> - Bioruby Statsample TimeSeries.
...
-   [has\_scope](https://github.com/plataformatec/has_scope) <span> ★ 1092, pushed 128 days ago </span> - Has scope allows you to easily create controller filters based on your resources named scopes.
-   [Mongoid Search](https://github.com/mauriciozaffari/mongoid_search) <span> ★ 259, pushed 148 days ago </span> - Simple full text search implementation for Mongoid.
-   [pg\_search](https://github.com/Casecommons/pg_search) <span> ★ 1498, pushed 1 days ago </span> - Builds ActiveRecord named scopes that take advantage of PostgreSQL's full text search.
-   [ransack](https://github.com/activerecord-hackery/ransack/) - Object-based searching.
-   [Rroonga](https://github.com/ranguba/rroonga) <span> ★ 46, pushed 19 days ago </span> - The Ruby bindings of Groonga.
-   [SearchCop](https://github.com/mrkamel/search_cop) <span> ★ 397, pushed 102 days ago </span> - Extends your ActiveRecord models to support fulltext search engine like queries via simple query strings and hash-based queries.
-   [Searchkick](https://github.com/ankane/searchkick) <span> ★ 2767, pushed 6 days ago </span> - Searchkick learns what your users are looking for. As more people search, it gets smarter and the results get better. It’s friendly for developers - and magical for your users.
-   [Searchlogic](https://github.com/binarylogic/searchlogic) <span> ★ 1405, pushed 616 days ago </span> - Object based searching, common named scopes, and other useful named scope tools for ActiveRecord.
-   [Sunspot](https://github.com/sunspot/sunspot) <span> ★ 2541, pushed 12 days ago </span> - A Ruby library for expressive, powerful interaction with the Solr search engine.
-   [textacular](https://github.com/textacular/textacular) <span> ★ 467, pushed 7 days ago </span> - Exposes full text search capabilities from PostgreSQL, and allows you to declare full text indexes. Textacular extends ActiveRecord with named\_scope methods making searching easy and fun!
-   [Thinking Sphinx](https://github.com/pat/thinking-sphinx) <span> ★ 1469, pushed 8 days ago </span> - A library for connecting ActiveRecord to the Sphinx full-text search tool.

Security
--------

-   [bundler-audit](https://github.com/rubysec/bundler-audit) <span> ★ 1107, pushed 4 days ago </span> - Patch-level security verification for Bundler.
-   [Gitrob](https://github.com/michenriksen/gitrob) <span> ★ 1273, pushed 6 days ago </span> - Reconnaissance tool for GitHub organizations.
-   [Metasploit](https://github.com/rapid7/metasploit-framework) <span> ★ 5772, pushed 0 days ago </span> - World's most used penetration testing software.
-   [Rack::Attack](https://github.com/kickstarter/rack-attack) <span> ★ 2534, pushed 47 days ago </span> - Rack middleware for blocking & throttling abusive requests.
-   [Rack::Protection](https://github.com/sinatra/rack-protection) <span> ★ 837, pushed 106 days ago </span> - Rack middleware for protecting against typical Web attacks.
-   [RbNaCl](https://github.com/cryptosphere/rbnacl) <span> ★ 496, pushed 4 days ago </span> - Ruby binding to the Networking and Cryptography (NaCl) library.
-   [SecureHeaders](https://github.com/twitter/secureheaders) <span> ★ 1672, pushed 1 days ago </span> - Automatically apply several headers that are related to security, including: Content Security Policy (CSP), HTTP Strict Transport Security (HSTS), X-Frame-Options (XFO), X-XSS-Protection, X-Content-Type-Options, X-Download-Options & X-Permitted-Cross-Domain-Policies.

SEO
---

-   [FriendlyId](https://github.com/norman/friendly_id) <span> ★ 4056, pushed 2 days ago </span> - The "Swiss Army bulldozer" of slugging and permalink plugins for Active Record.
-   [MetaTags](https://github.com/kpumuk/meta-tags) <span> ★ 1290, pushed 57 days ago </span> - A gem to make your Rails application SEO-friendly.
-   [prerender\_rails](https://github.com/prerender/prerender_rails) <span> ★ 255, pushed 85 days ago </span> - Rails middleware gem for prerendering javascript-rendered pages on the fly for SEO.
-   [SitemapGenerator](https://github.com/kjvarga/sitemap_generator) <span> ★ 1501, pushed 29 days ago </span> - A framework-agnostic XML Sitemap generator written in Ruby.

Social Networking
-----------------

-   [diaspora\*](https://github.com/diaspora/diaspora) <span> ★ 10686, pushed 0 days ago </span> - A privacy aware, distributed, open source social network.
-   [Discourse](https://github.com/discourse/discourse) <span> ★ 18195, pushed 0 days ago </span> - A platform for community discussion. Free, open, simple.
-   [Forem](https://github.com/radar/forem) - Rails 3 and Rails 4 forum engine.
-   [Mailboxer](https://github.com/mailboxer/mailboxer) <span> ★ 1301, pushed 7 days ago </span> - A private message system for Rails applications.
-   [Social Shares](https://github.com/Timrael/social_shares) <span> ★ 243, pushed 31 days ago </span> - A gem to check how many times url was shared in social networks.
-   [Thredded](https://github.com/thredded/thredded) <span> ★ 351, pushed 0 days ago </span> - Rails 4.2+ forum/messageboard engine. Its goal is to be as simple and feature rich as possible.

Spreadsheets and Documents
--------------------------

-   [AXLSX](https://github.com/randym/axlsx) <span> ★ 1624, pushed 5 days ago </span> - An excel xlsx generation library.
...
-   [Roo](https://github.com/roo-rb/roo) <span> ★ 1307, pushed 27 days ago </span> - Implements read access for all spreadsheet types and read/write access for Google spreadsheets.
-   [Yomu](https://github.com/Erol/yomu) <span> ★ 299, pushed 161 days ago </span> - Read text and metadata from files and documents (.doc, .docx, .pages, .odt, .rtf, .pdf).

State Machines
--------------

-   [AASM](https://github.com/aasm/aasm) <span> ★ 2356, pushed 2 days ago </span> - State machines for Ruby classes (plain Ruby, Rails Active Record, Mongoid).
...
-   [simple\_states](https://github.com/svenfuchs/simple_states) <span> ★ 77, pushed 15 days ago </span> - A super-slim statemachine-like support library.
-   [Statesman](https://github.com/gocardless/statesman) <span> ★ 722, pushed 4 days ago </span> - A statesmanlike state machine library.
-   [transitions](https://github.com/troessner/transitions) <span> ★ 474, pushed 9 days ago </span> - A ruby state machine implementation.
-   [Workflow](https://github.com/geekq/workflow) <span> ★ 1287, pushed 22 days ago </span> - A finite-state-machine-inspired API for modeling and interacting with what we tend to refer to as 'workflow'.

Static Site Generation
----------------------

-   [High Voltage](https://github.com/thoughtbot/high_voltage) <span> ★ 2305, pushed 13 days ago </span> - Easily include static pages in your Rails app.
-   [Jekyll](http://jekyllrb.com) - Transform your plain text into static websites and blogs.
    -   [Awesome Jekyll](https://github.com/planetjekyll/awesome-jekyll) <span> ★ 179, pushed 20 days ago </span> - A collection of awesome Jekyll tools, plugins, themes, guides and much more.
...
-   [Octopress](https://github.com/octopress/octopress) <span> ★ 1374, pushed 93 days ago </span> - Octopress is an obsessively designed toolkit for writing and deploying Jekyll blogs.
-   [Photish](https://github.com/henrylawson/photish) <span> ★ 103, pushed 106 days ago </span> - Generate a highly configurable static website from a photo collection.
-   [webgen](http://webgen.gettalong.org) - webgen is a fast, powerful and extensible static website generator.

Template Engine
---------------

-   [Curly](https://github.com/zendesk/curly) <span> ★ 548, pushed 105 days ago </span> - A template language that completely separates structure and logic.
-   [Haml](https://github.com/haml/haml) <span> ★ 2946, pushed 76 days ago </span> - HTML Abstraction Markup Language.
-   [Liquid](https://github.com/Shopify/liquid) <span> ★ 4470, pushed 16 days ago </span> - Safe, customer facing template language for flexible web apps.
-   [Mustache](https://github.com/mustache/mustache) <span> ★ 2186, pushed 48 days ago </span> - Logic-less Ruby templates.
-   [Slim](https://github.com/slim-template/slim) <span> ★ 3915, pushed 11 days ago </span> - A template language whose goal is reduce the syntax to the essential parts without becoming cryptic.
...
-   Frameworks
    -   [RSpec](https://github.com/rspec/rspec) <span> ★ 1552, pushed 39 days ago </span> - Behaviour Driven Development for Ruby.
    -   Formatters
        -   [Emoji-RSpec](https://github.com/cupakromer/emoji-rspec) <span> ★ 163, pushed 878 days ago </span> - Custom Emoji Formatters for RSpec.
        -   [Fuubar](https://github.com/thekompanee/fuubar) <span> ★ 631, pushed 16 days ago </span> - The instafailing RSpec progress bar formatter.
        -   [Nyan Cat](https://github.com/mattsears/nyan-cat-formatter) <span> ★ 567, pushed 401 days ago </span> - Nyan Cat inspired RSpec formatter!
    ...
    -   [Bacon](https://github.com/chneukirchen/bacon) <span> ★ 385, pushed 274 days ago </span> - A small RSpec clone.
    -   [Capybara](http://jnicklas.github.io/capybara) - Acceptance test framework for web applications.
    -   [Cucumber](https://github.com/cucumber/cucumber) <span> ★ 367, pushed 26 days ago </span> - BDD that talks to domain experts first and code second.
    -   [Cutest](https://github.com/djanowski/cutest) <span> ★ 132, pushed 15 days ago </span> - Isolated tests in Ruby.
    -   [Howitzer](https://github.com/strongqa/howitzer) <span> ★ 124, pushed 98 days ago </span> - Ruby based framework for acceptance testing
    -   [Konacha](https://github.com/jfirebaugh/konacha) <span> ★ 1028, pushed 33 days ago </span> - Test your Rails application's JavaScript with the mocha test framework and chai assertion library.
    -   [minitest](https://github.com/seattlerb/minitest) <span> ★ 1865, pushed 3 days ago </span> - minitest provides a complete suite of testing facilities supporting TDD, BDD, mocking, and benchmarking.
    -   [RR](https://github.com/rr/rr) <span> ★ 217, pushed 90 days ago </span> - A test double framework that features a rich selection of double techniques and a terse syntax.
    -   [shoulda-matchers](https://github.com/thoughtbot/shoulda-matchers) <span> ★ 1649, pushed 0 days ago </span> - Provides Test::Unit- and RSpec-compatible one-liners that test common Rails functionality. These tests would otherwise be much longer, more complex, and error-prone.
    -   [Spinach](https://github.com/codegram/spinach) <span> ★ 484, pushed 42 days ago </span> - Spinach is a high-level BDD framework that leverages the expressive Gherkin language (used by Cucumber) to help you define executable specifications of your application or library's acceptance criteria.
    -   [Spork](https://github.com/sporkrb/spork) <span> ★ 1406, pushed 38 days ago </span> - A DRb server for testing frameworks (RSpec / Cucumber currently).
...
-   Fake Data
    ...
    -   [factory\_girl](https://github.com/thoughtbot/factory_girl) <span> ★ 4742, pushed 18 days ago </span> - A library for setting up Ruby objects as test data.
    -   [Fake Person](https://github.com/adamcooke/fake-person) <span> ★ 114, pushed 570 days ago </span> - Uses some of the most popular given & surnames in the US & UK.
    -   [faker](https://github.com/stympy/faker) <span> ★ 3787, pushed 2 days ago </span> - A library for generating fake data such as names, addresses, and phone numbers.
    -   [ffaker](https://github.com/ffaker/ffaker) <span> ★ 973, pushed 2 days ago </span> - A faster Faker, generates dummy data, rewrite of faker.
    -   [Forgery](https://github.com/sevenwire/forgery) <span> ★ 721, pushed 370 days ago </span> - Easy and customizable generation of forged data.
    -   [Machinist](https://github.com/notahat/machinist) <span> ★ 1134, pushed 1011 days ago </span> - Fixtures aren't fun. Machinist is.
-   Mock
    -   [ActiveMocker](https://github.com/zeisler/active_mocker) <span> ★ 293, pushed 6 days ago </span> - Generate mocks from ActiveRecord models for unit tests that run fast because they don’t need to load Rails or a database.
    -   [DuckRails](https://github.com/iridakos/duckrails) <span> ★ 894, pushed 7 days ago </span> - Tool for mocking API endpoints quickly & dynamically.
    -   [TestXml](https://github.com/alovak/test_xml) <span> ★ 25, pushed 417 days ago </span> - TestXml is a small extension for testing XML/HTML.
    -   [WebMock](https://github.com/bblimke/webmock) <span> ★ 2150, pushed 0 days ago </span> - Library for stubbing and setting expectations on HTTP requests.
-   WebDrivers
    -   [Selenium WebDriver](http://selenium.googlecode.com/git/docs/api/rb/index.html) - This gem provides Ruby bindings for WebDriver.
    -   [API Taster](https://github.com/fredwu/api_taster) <span> ★ 723, pushed 418 days ago </span> - A quick and easy way to visually test your Rails application's API.
    -   [Poltergeist](https://github.com/teampoltergeist/poltergeist) <span> ★ 2105, pushed 22 days ago </span> - A PhantomJS driver for Capybara.
...
-   Extra
    ...
    -   [mutant](https://github.com/mbj/mutant) <span> ★ 1091, pushed 2 days ago </span> - Mutant is a mutation testing tool for Ruby.
    -   [Parallel Tests](https://github.com/grosser/parallel_tests) <span> ★ 1745, pushed 2 days ago </span> - Speedup Test::Unit + RSpec + Cucumber by running parallel on multiple CPUs (or cores).
    -   [Ruby-JMeter](https://github.com/flood-io/ruby-jmeter) <span> ★ 427, pushed 138 days ago </span> - A Ruby based DSL for building JMeter test plans.
    -   [Spring](https://github.com/rails/spring) <span> ★ 2118, pushed 29 days ago </span> - Preloads your rails environment in the background for faster testing and Rake tasks.
    -   [timecop](https://github.com/travisjeffery/timecop) <span> ★ 2061, pushed 33 days ago </span> - Provides "time travel" and "time freezing" capabilities, making it dead simple to test time-dependent code.
    -   [vcr](https://github.com/vcr/vcr) <span> ★ 2950, pushed 5 days ago </span> - Record your test suite's HTTP interactions and replay them during future test runs for fast, deterministic, accurate tests.
    ...
    -   [Wrong](https://github.com/sconover/wrong) <span> ★ 409, pushed 202 days ago </span> - Wrong provides a general assert method that takes a predicate block. Assertion failure messages are rich in detail.

Third-party APIs
----------------

-   [databasedotcom](https://github.com/heroku/databasedotcom) <span> ★ 332, pushed 64 days ago </span> - Ruby client for the Salesforce's Database.com and Chatter APIs.
-   [Dropbox](https://github.com/futuresimple/dropbox-api) <span> ★ 348, pushed 163 days ago </span> - Dropbox API Ruby Client.
-   [facy](https://github.com/huydx/facy) <span> ★ 212, pushed 162 days ago </span> - Command line power tool for facebook.
-   [fb\_graph](https://github.com/nov/fb_graph) <span> ★ 1088, pushed 125 days ago </span> - A full-stack Facebook Graph API wrapper.
-   [flickr](https://github.com/RaVbaker/flickr) <span> ★ 17, pushed 682 days ago </span> - A Ruby interface to the Flickr API.
-   [gitlab](https://github.com/NARKOZ/gitlab) <span> ★ 286, pushed 2 days ago </span> - Ruby wrapper and CLI for the GitLab API.
-   [gmail](https://github.com/gmailgem/gmail) <span> ★ 176, pushed 30 days ago </span> - A Rubyesque interface to Gmail, with all the tools you'll need.
-   [hipchat-rb](https://github.com/hipchat/hipchat-rb) <span> ★ 322, pushed 58 days ago </span> - HipChat HTTP API Wrapper in Ruby with Capistrano hooks.
-   [instagram-ruby-gem](https://github.com/Instagram/instagram-ruby-gem) - The official gem for the Instagram REST and Search APIs.
-   [itunes *store* transporter](https://github.com/sshaw/itunes_store_transporter) <span> ★ 88, pushed 81 days ago </span> - Ruby wrapper around Apple's iTMSTransporter program.
-   [linkedin](https://github.com/hexgnu/linkedin) <span> ★ 698, pushed 8 days ago </span> - Provides an easy-to-use wrapper for LinkedIn's REST APIs.
-   [Octokit](http://octokit.github.io/octokit.rb) - Ruby toolkit for the GitHub API.
-   [Pusher](https://github.com/pusher/pusher-http-ruby) <span> ★ 507, pushed 79 days ago </span> - Ruby server library for the Pusher API.
-   [ruby-gmail](https://github.com/dcparker/ruby-gmail) <span> ★ 739, pushed 296 days ago </span> - A Rubyesque interface to Gmail.
-   [ruby-trello](https://github.com/jeremytregunna/ruby-trello) <span> ★ 528, pushed 1 days ago </span> - Implementation of the Trello API for Ruby.
-   [simple-slack-bot](https://github.com/kciter/simple-slack-bot) <span> ★ 144, pushed 81 days ago </span> - You can easily make Slack Bot.
-   [Slack Notifier](https://github.com/stevenosloan/slack-notifier) <span> ★ 616, pushed 26 days ago </span> - A simple wrapper for posting to Slack channels.
-   [Slack ruby gem](https://github.com/aki017/slack-ruby-gem) <span> ★ 149, pushed 2 days ago </span> - A Ruby wrapper for the Slack API.
-   [soundcloud-ruby](https://github.com/soundcloud/soundcloud-ruby) <span> ★ 290, pushed 222 days ago </span> - Official SoundCloud API Wrapper for Ruby.
-   [t](https://github.com/sferik/t) <span> ★ 3734, pushed 20 days ago </span> - A command-line power tool for Twitter.
-   [tweetstream](https://github.com/tweetstream/tweetstream) <span> ★ 1076, pushed 100 days ago </span> - A simple library for consuming Twitter's Streaming API.
-   [twilio-ruby](https://github.com/twilio/twilio-ruby) <span> ★ 856, pushed 8 days ago </span> - A module for using the Twilio REST API and generating valid TwiML.
-   [twitter](https://github.com/sferik/twitter) <span> ★ 3558, pushed 6 days ago </span> - A Ruby interface to the Twitter API.
-   [wikipedia](https://github.com/kenpratt/wikipedia-client) <span> ★ 155, pushed 20 days ago </span> - Ruby client for the Wikipedia API.
-   [Yt](https://github.com/Fullscreen/yt) <span> ★ 411, pushed 1 days ago </span> - An object-oriented Ruby client for YouTube API V3.

Video
-----

-   [Streamio FFMPEG](https://github.com/streamio/streamio-ffmpeg) <span> ★ 947, pushed 12 days ago </span> - Simple yet powerful wrapper around the ffmpeg command for reading metadata and transcoding movies.

Web Crawling
------------

-   [anemone](https://github.com/chriskite/anemone) <span> ★ 1491, pushed 114 days ago </span> - Ruby library and CLI for crawling websites.
-   [LinkThumbnailer](https://github.com/gottfrois/link_thumbnailer) <span> ★ 301, pushed 23 days ago </span> - Ruby gem that generates thumbnail images and videos from a given URL. Much like popular social website with link preview.
-   [Mechanize](https://github.com/sparklemotion/mechanize) <span> ★ 2973, pushed 6 days ago </span> - Mechanize is a ruby library that makes automated web interaction easy.
-   [MetaInspector](https://github.com/jaimeiniesta/metainspector) <span> ★ 621, pushed 7 days ago </span> - Ruby gem for web scraping purposes.
-   [Upton](https://github.com/propublica/upton) <span> ★ 1485, pushed 174 days ago </span> - A batteries-included framework for easy web-scraping.
-   [Wombat](https://github.com/felipecsl/wombat) <span> ★ 791, pushed 41 days ago </span> - Web scraper with an elegant DSL that parses structured data from web pages.
...
-   [Hobbit](https://github.com/patriciomacadden/hobbit) <span> ★ 246, pushed 81 days ago </span> - A minimalistic microframework built on top of Rack.
...
-   [Volt](https://github.com/voltrb/volt) <span> ★ 3235, pushed 44 days ago </span> - A Ruby web framework where your ruby code runs on both the server and the client.

Web Servers
-----------

-   [Goliath](https://github.com/postrank-labs/goliath) <span> ★ 2320, pushed 89 days ago </span> - A non-blocking Ruby web server framework.
-   [Phusion Passenger](https://www.phusionpassenger.com) - Fast and robust web server and application server.
-   [Puma](https://github.com/puma/puma) <span> ★ 4089, pushed 2 days ago </span> - A modern, concurrent web server for Ruby.
...
-   [Reel](https://github.com/celluloid/reel) <span> ★ 582, pushed 48 days ago </span> - Celluloid::IO-powered web server.
-   [Thin](http://code.macournoyer.com/thin) - Tiny, fast & funny HTTP server.
-   [TorqueBox](https://github.com/torquebox/torquebox) <span> ★ 461, pushed 6 days ago </span> - A Ruby application server built on JBoss AS7 and JRuby.
...
-   [Firehose](https://github.com/firehoseio/firehose) <span> ★ 622, pushed 50 days ago </span> - Build realtime Ruby web applications.
-   [Rails Realtime](https://github.com/liamks/rails-realtime) <span> ★ 105, pushed 1092 days ago </span> - Adding Real-Time To Your RESTful Rails App.
-   [Slanger](https://github.com/stevegraham/slanger) <span> ★ 1399, pushed 58 days ago </span> - Open Pusher implementation compatible with Pusher libraries.
-   [Sync](https://github.com/chrismccord/sync) - Real-time Rails Partials.
-   [Websocket-Rails](https://github.com/websocket-rails/websocket-rails) <span> ★ 1529, pushed 24 days ago </span> - Creates a built in WebSocket server inside a Rails application with ease, and also support streaming HTTP.
...
-   [Ruby Bookmarks](https://github.com/dreikanter/ruby-bookmarks) <span> ★ 1112, pushed 19 days ago </span> - Ruby and Ruby on Rails bookmarks collection.
