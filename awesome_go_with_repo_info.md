...
-   [music-theory](https://github.com/go-music-theory/music-theory) <span> ★ 94, updated 4 days ago </span> - Music theory models in Go.
...
-   [authboss](https://github.com/go-authboss/authboss) <span> ★ 590, updated 1 days ago </span> - A modular authentication system for the web. It tries to remove as much boilerplate and "hard things" as possible so that each time you start a new web project in Go, you can plug it in, configure, and start building your app without having to build an authentication system each time.
...
-   [gorbac](https://github.com/mikespook/gorbac) <span> ★ 325, updated 3 days ago </span> - provides a lightweight role-based access control (RBAC) implementation in Golang.
-   [goth](https://github.com/markbates/goth) <span> ★ 674, updated 1 days ago </span> - provides a simple, clean, and idiomatic way to use OAuth and OAuth2. Handles multiple provides out of the box.
-   [httpauth](https://github.com/goji/httpauth) <span> ★ 91, updated 20 days ago </span> - HTTP Authentication middleware.
-   [jwt-go](https://github.com/dgrijalva/jwt-go) <span> ★ 1085, updated 1 days ago </span> - Golang implementation of JSON Web Tokens (JWT).
...
-   [osin](https://github.com/RangelReale/osin) <span> ★ 854, updated 1 days ago </span> - Golang OAuth2 server library.
...
-   [cli-init](https://github.com/tcnksm/gcli) <span> ★ 476, updated 2 days ago </span> - The easy way to start building Golang command line application.
-   [climax](http://github.com/tucnak/climax) - An alternative CLI with "human face", in spirit of Go command
-   [cobra](https://github.com/spf13/cobra) <span> ★ 1949, updated 1 days ago </span> - A Commander for modern Go CLI interactions
-   [codegangsta/cli](https://github.com/codegangsta/cli) <span> ★ 4048, updated 2 days ago </span> - A small package for building command line apps in Go.
...
-   [liner](https://github.com/peterh/liner) <span> ★ 297, updated 1 days ago </span> - A Go readline-like library for command-line interfaces.
...
-   [readline](https://github.com/chzyer/readline) <span> ★ 551, updated 3 days ago </span> - A pure golang implementation that provide most of features in GNU-Readline under MIT license.
...
-   [color](https://github.com/fatih/color) <span> ★ 837, updated 2 days ago </span> - Versatile package for colored terminal output.
...
-   [termbox-go](https://github.com/nsf/termbox-go) <span> ★ 1400, updated 1 days ago </span> - Termbox is a library for creating cross-platform text-based interfaces.
...
-   [termui](https://github.com/gizak/termui) <span> ★ 4620, updated 1 days ago </span> - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib) .
...
-   [uitable](https://github.com/gosuri/uitable) <span> ★ 282, updated 7 days ago </span> - A library to improve readability in terminal apps using tabular data.
...
-   [config](https://github.com/olebedev/config) <span> ★ 70, updated 4 days ago </span> - JSON or YAML configuration wrapper with environment variables and flags parsing.
...
-   [envcfg](https://github.com/tomazk/envcfg) <span> ★ 75, updated 53 days ago </span> - Un-marshaling environment variables to Go structs.
...
-   [ini](https://github.com/go-ini/ini) <span> ★ 261, updated 1 days ago </span> - Go package for read and write INI files
-   [mini](https://github.com/FogCreek/mini) <span> ★ 84, updated 26 days ago </span> - A golang package for parsing ini-style configuration files
-   [store](https://github.com/tucnak/store) <span> ★ 38, updated 4 days ago </span> - A lightweight configuration manager for Go
-   [viper](https://github.com/spf13/viper) <span> ★ 1469, updated 1 days ago </span> - Go configuration with fangs
...
-   [drone](https://github.com/drone/drone) <span> ★ 6649, updated 0 days ago </span> - Drone is a Continuous Integration platform built on Docker, written in Go
...
-   [bitset](https://github.com/willf/bitset) <span> ★ 197, updated 7 days ago </span> - Go package implementing bitsets.
-   [bloom](https://github.com/zhenjl/bloom) <span> ★ 82, updated 4 days ago </span> - Bloom filters implemented in Go.
-   [boomfilters](https://github.com/tylertreat/BoomFilters) <span> ★ 687, updated 1 days ago </span> - probabilistic data structures for processing continuous, unbounded streams
...
-   [go-datastructures](https://github.com/Workiva/go-datastructures) <span> ★ 2419, updated 1 days ago </span> - a collection of useful, performant, and thread-safe data structures
...
-   [bolt](https://github.com/boltdb/bolt) <span> ★ 4010, updated 1 days ago </span> - A low-level key/value database for Go.
...
-   [cockroach](https://github.com/cockroachdb/cockroach) <span> ★ 6698, updated 0 days ago </span> - A Scalable, Geo-Replicated, Transactional Datastore
...
-   [dgraph](https://github.com/dgraph-io/dgraph) <span> ★ 1079, updated 1 days ago </span> - Scalable, Distributed, Low Latency, High Throughput Graph Database.
-   [diskv](https://github.com/peterbourgon/diskv) <span> ★ 343, updated 5 days ago </span> - A home-grown disk-backed key-value store.
...
-   [goleveldb](https://github.com/syndtr/goleveldb) <span> ★ 1014, updated 3 days ago </span> - An implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in the Go.
-   [groupcache](https://github.com/golang/groupcache) <span> ★ 4389, updated 2 days ago </span> - Groupcache is a caching and cache-filling library, intended as a replacement for memcached in many cases.
-   [influxdb](https://github.com/influxdb/influxdb) - Scalable datastore for metrics, events, and real-time analytics
-   [ledisdb](https://github.com/siddontang/ledisdb) <span> ★ 1572, updated 2 days ago </span> - Ledisdb is a high performance NoSQL like Redis based on LevelDB.
-   [levigo](https://github.com/jmhodges/levigo) <span> ★ 268, updated 4 days ago </span> - Levigo is a Go wrapper for LevelDB.
-   [prometheus](https://github.com/prometheus/prometheus) <span> ★ 4380, updated 1 days ago </span> - Monitoring system and time series database.
-   [rqlite](https://github.com/otoolep/rqlite) <span> ★ 1267, updated 4 days ago </span> - Replicated SQLite, using Raft consensus.
-   [tidb](https://github.com/pingcap/tidb) <span> ★ 3797, updated 1 days ago </span> - TiDB is a distributed SQL database. Inspired by the design of Google F1.
-   [tiedot](https://github.com/HouzuoGuo/tiedot) <span> ★ 1503, updated 3 days ago </span> - Your NoSQL database powered by Golang.
-   [Tile38](https://github.com/tidwall/tile38) <span> ★ 1087, updated 1 days ago </span> - A geolocation DB with spatial index and realtime geofencing.
...
-   [migrate](https://github.com/mattes/migrate) <span> ★ 571, updated 1 days ago </span> - Database migration handling in Golang support MySQL,PostgreSQL,Cassandra and SQLite.
...
-   [pgweb](https://github.com/sosedoff/pgweb) <span> ★ 3366, updated 1 days ago </span> - A web-based PostgreSQL database browser
...
-   [sql-migrate](https://github.com/rubenv/sql-migrate) <span> ★ 439, updated 6 days ago </span> - Database migration tool. Allows embedding migrations into the application using go-bindata.
-   [vitess](https://github.com/youtube/vitess) <span> ★ 3398, updated 1 days ago </span> - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.

*SQL query builder, libraries for building and using SQL.*

-   [dat](https://github.com/mgutz/dat) <span> ★ 283, updated 4 days ago </span> - Go Postgres Data Access Toolkit
-   [Dotsql](https://github.com/gchaincl/dotsql) <span> ★ 223, updated 23 days ago </span> - Go library that helps you keep sql files in one place and use it with ease.
-   [goqu](https://github.com/doug-martin/goqu) <span> ★ 250, updated 7 days ago </span> - An idiomatic SQL builder and query library.
-   [igor](https://github.com/galeone/igor) <span> ★ 48, updated 1 days ago </span> - Abstraction layer for PostgreSQL that supports advanced functionality and uses gorm-like syntax.
...
-   Relational Databases
    ...
    -   [go-mssqldb](https://github.com/denisenkom/go-mssqldb) <span> ★ 309, updated 12 days ago </span> - Microsoft MSSQL driver prototype in go language.
    -   [go-oci8](https://github.com/mattn/go-oci8) <span> ★ 124, updated 15 days ago </span> - Oracle driver for go that using database/sql.
    -   [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) <span> ★ 2272, updated 1 days ago </span> - MySQL driver for Go.
    -   [go-sqlite3](https://github.com/mattn/go-sqlite3) <span> ★ 1178, updated 2 days ago </span> - SQLite3 driver for go that using database/sql.
    ...
    -   [pq](https://github.com/lib/pq) <span> ★ 2023, updated 1 days ago </span> - Pure Go Postgres driver for database/sql.
-   NoSQL Databases

    -   [aerospike-client-go](https://github.com/aerospike/aerospike-client-go) <span> ★ 165, updated 5 days ago </span> <span> ★ 165, updated 5 days ago </span> - Aerospike client in Go language.
    ...
    -   [gorethink](https://github.com/dancannon/gorethink) <span> ★ 860, updated 1 days ago </span> - Go language driver for RethinkDB
    ...
    -   [redis](https://github.com/go-redis/redis) <span> ★ 768, updated 1 days ago </span> - Redis client for Golang
...
-   Search and Analytic Databases
    ...
    -   [bleve](https://github.com/blevesearch/bleve) <span> ★ 2451, updated 2 days ago </span> <span> ★ 2451, updated 2 days ago </span> - A modern text indexing library for go.
    -   [elastic](https://github.com/olivere/elastic) <span> ★ 604, updated 1 days ago </span> - Elasticsearch client for Google Go.
...
-   [glow](https://github.com/chrislusf/glow) <span> ★ 876, updated 1 days ago </span> - Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go.
...
-   [grpc-go](https://github.com/grpc/grpc-go) <span> ★ 1665, updated 0 days ago </span> - The Go language implementation of gRPC. HTTP/2 based RPC.
-   [micro](https://github.com/micro/micro) <span> ★ 1724, updated 1 days ago </span> - A pluggable microservice toolkit and distributed systems platform.
-   [raft](https://github.com/hashicorp/raft) <span> ★ 573, updated 1 days ago </span> - Golang implementation of the Raft consensus protocol, by HashiCorp.
-   [torrent](https://github.com/anacrolix/torrent) <span> ★ 1113, updated 1 days ago </span> - BitTorrent client package.
...
-   [email](https://github.com/jordan-wright/email) <span> ★ 668, updated 6 days ago </span> - A robust and flexible email library for Go.
...
-   [MailHog](https://github.com/mailhog/MailHog) <span> ★ 820, updated 0 days ago </span> - Email and SMTP testing with web and API interface
...
-   [gisp](https://github.com/jcla1/gisp) <span> ★ 323, updated 8 days ago </span> - Simple LISP in Go
...
-   [go-lua](https://github.com/Shopify/go-lua) <span> ★ 642, updated 2 days ago </span> - A port of the Lua 5.2 VM to pure Go
...
-   [golua](https://github.com/aarzilli/golua) <span> ★ 266, updated 13 days ago </span> - Go bindings for Lua C API
-   [gopher-lua](https://github.com/yuin/gopher-lua) <span> ★ 1157, updated 2 days ago </span> - a Lua 5.1 VM and compiler written in Go
...
-   [binding](https://github.com/mholt/binding) <span> ★ 461, updated 1 days ago </span> - Binds form and JSON data from net/http Request to struct.
...
-   [gorilla/csrf](https://github.com/gorilla/csrf) <span> ★ 106, updated 1 days ago </span> - CSRF protection for Go web applications & services.
...
-   [engo](https://github.com/EngoEngine/engo) <span> ★ 122, updated 1 days ago </span> - Engo is an open-source 2D game engine written in Go. It follows the Entity-Component-System paradigm.
...
-   [go-astar](https://github.com/beefsack/go-astar) <span> ★ 144, updated 14 days ago </span> - Go implementation of the A\* path finding algorithm
...
-   [termloop](https://github.com/JoelOtter/termloop) <span> ★ 608, updated 8 days ago </span> - Terminal-based game engine for Go, built on top of Termbox
...
-   [gen](https://github.com/clipperhouse/gen) <span> ★ 674, updated 2 days ago </span> - Code generation tool for ‘generics’-like functionality.
-   [go-linq](https://github.com/ahmetalpbalkan/go-linq) <span> ★ 753, updated 3 days ago </span> - .NET LINQ-like query methods for Go.
...
-   [gopherjs](https://github.com/gopherjs/gopherjs) <span> ★ 3756, updated 1 days ago </span> - A compiler from Go to JavaScript.
-   [llgo](https://github.com/go-llvm/llgo) <span> ★ 733, updated 0 days ago </span> - LLVM-based compiler for Go.
-   [tardisgo](https://github.com/tardisgo/tardisgo) <span> ★ 308, updated 20 days ago </span> - Golang to Haxe to CPP/CSharp/Java/JavaScript transpiler.
...
-   [go-qml](https://github.com/go-qml/qml) <span> ★ 1648, updated 0 days ago </span> - QML support for the Go language
-   [goqt](https://github.com/visualfc/goqt) <span> ★ 975, updated 0 days ago </span> - Golang bindings to the Qt cross-platform application framework.
...
-   [systray](https://github.com/getlantern/systray) <span> ★ 64, updated 2 days ago </span> - Cross platform Go library to place an icon and menu in the notification area
...
-   [bimg](https://github.com/h2non/bimg) <span> ★ 154, updated 5 days ago </span> - Small package for fast and efficient image processing using libvips
...
-   [go-opencv](https://github.com/lazywei/go-opencv) <span> ★ 376, updated 1 days ago </span> - Go bindings for OpenCV.
...
-   [imagick](https://github.com/gographics/imagick) <span> ★ 404, updated 2 days ago </span> - Go binding to ImageMagick's MagickWand C API.
-   [imaginary](https://github.com/h2non/imaginary) <span> ★ 730, updated 1 days ago </span> - Fast and simple HTTP microservice for image resizing
-   [imaging](https://github.com/disintegration/imaging) <span> ★ 786, updated 3 days ago </span> - Simple Go image processing package.
...
-   [svgo](https://github.com/ajstarks/svgo) <span> ★ 715, updated 2 days ago </span> - Go Language Library for SVG generation.
...
-   [glog](https://github.com/golang/glog) <span> ★ 965, updated 1 days ago </span> - Leveled execution logs for Go.
...
-   [logrus](https://github.com/Sirupsen/logrus) <span> ★ 2583, updated 0 days ago </span> - a structured logger for Go.
...
-   [logxi](https://github.com/mgutz/logxi) <span> ★ 243, updated 1 days ago </span> - A 12-factor app logger that is fast and makes you happy.
-   [lumberjack](https://github.com/natefinch/lumberjack) <span> ★ 292, updated 8 days ago </span> - Simple rolling logger, implements io.WriteCloser.
...
-   [ozzo-log](https://github.com/go-ozzo/ozzo-log) <span> ★ 39, updated 5 days ago </span> - High performance logging supporting log severity, categorization, and filtering. Can send filtered log messages to various targets (e.g. console, network, mail).
-   [seelog](https://github.com/cihub/seelog) <span> ★ 637, updated 3 days ago </span> - logging functionality with flexible dispatching, filtering, and formatting.
-   [slf](https://github.com/ventu-io/slf) <span> ★ 25, updated 12 days ago </span> - The Structured Logging Facade (SLF) for Go (like SLF4J but structured and for Go)
...
-   [tail](https://github.com/hpcloud/tail) <span> ★ 480, updated 0 days ago </span> - A Go package striving to emulate the features of the BSD tail program.
...
-   [goml](https://github.com/cdipaolo/goml) <span> ★ 460, updated 4 days ago </span> - On-line Machine Learning in Go
...
-   [Centrifugo](https://github.com/centrifugal/centrifugo) <span> ★ 1002, updated 3 days ago </span> - Real-time messaging (Websockets or SockJS) server in Go.
-   [dbus](https://github.com/godbus/dbus) <span> ★ 80, updated 1 days ago </span> - Native Go bindings for D-Bus.
-   [emitter](https://github.com/olebedev/emitter) <span> ★ 49, updated 3 days ago </span> - Emits events using Go way, with wildcard, predicates, cancellation possibilities and many other good wins.
...
-   [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster) <span> ★ 1182, updated 2 days ago </span> - gopush-cluster is a go push server cluster.
-   [gorush](https://github.com/appleboy/gorush) <span> ★ 21, updated 1 days ago </span> - A push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm) .
-   [machinery](https://github.com/RichardKnop/machinery) <span> ★ 782, updated 1 days ago </span> - An asynchronous task queue/job queue based on distributed message passing.
-   [mangos](https://github.com/go-mangos/mangos) <span> ★ 813, updated 2 days ago </span> - Pure go implementation of the Nanomsg ("Scalable Protocols") with transport interoperability.
-   [NATS](https://github.com/nats-io/nats) <span> ★ 664, updated 1 days ago </span> - A lightweight and highly performant publish-subscribe and distributed queueing messaging system.
...
-   [sarama](https://github.com/Shopify/sarama) <span> ★ 936, updated 1 days ago </span> - A Go library for Apache Kafka.
...
-   [afero](https://github.com/spf13/afero) <span> ★ 564, updated 5 days ago </span> - A FileSystem Abstraction System for Go.
...
-   [go-commons-pool](https://github.com/jolestar/go-commons-pool) <span> ★ 232, updated 2 days ago </span> - A generic object pool for Golang.
...
-   [gosms](https://github.com/haxpax/gosms) <span> ★ 914, updated 4 days ago </span> - Your own local SMS gateway in Go that can be used to send SMS
-   [gountries](https://github.com/pariz/gountries) <span> ★ 83, updated 9 days ago </span> - A package that exposes country and subdivision data.
-   [health](https://github.com/dimiro1/health) <span> ★ 171, updated 5 days ago </span> - A Easy to use, extensible health check library.
-   [jobs](https://github.com/albrow/jobs) <span> ★ 324, updated 4 days ago </span> - A persistent and flexible background jobs library.
...
-   [MMSEGO](https://github.com/awsong/MMSEGO) <span> ★ 48, updated 10 days ago </span> - This is a GO implementation of [MMSEG](http://technology.chtsai.org/mmseg/) which a Chinese word splitting algorithm.
...
-   [canopus](https://github.com/zubairhamed/canopus) <span> ★ 26, updated 16 days ago </span> - CoAP Client/Server implementation (RFC 7252)
...
-   [dns](https://github.com/miekg/dns) <span> ★ 1465, updated 1 days ago </span> - Go library for working with DNS
...
-   [fasthttp](https://github.com/valyala/fasthttp) <span> ★ 2157, updated 0 days ago </span> - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http
-   [ftp](https://github.com/jlaffaye/ftp) <span> ★ 122, updated 4 days ago </span> - Package ftp implements a FTP client as described in [RFC 959](http://tools.ietf.org/html/rfc959) .
...
-   [golibwireshark](https://github.com/sunwxg/golibwireshark) <span> ★ 3, updated 7 days ago </span> - Package golibwireshark use libwireshark library to decode pcap file and analyse dissection data.
-   [gopacket](https://github.com/google/gopacket) <span> ★ 566, updated 4 days ago </span> - A Go library for packet processing with libpcap bindings
-   [gopcap](https://github.com/akrennmair/gopcap) <span> ★ 206, updated 17 days ago </span> - A Go wrapper for libpcap
...
-   [gosnmp](https://github.com/soniah/gosnmp) <span> ★ 104, updated 3 days ago </span> - Native Go library for performing SNMP actions
...
-   [mdns](https://github.com/hashicorp/mdns) <span> ★ 227, updated 8 days ago </span> - Simple mDNS (Multicast DNS) client/server library in Golang
...
-   [tcp\_server](https://github.com/firstrow/tcp_server) <span> ★ 42, updated 3 days ago </span> - A Go library for building tcp servers faster.
...
-   [go-store](https://github.com/gosuri/go-store) <span> ★ 71, updated 1 days ago </span> - A simple and fast Redis backed key-value store library for Go.
...
-   [GORM](https://github.com/jinzhu/gorm) <span> ★ 3639, updated 1 days ago </span> - The fantastic ORM library for Golang, aims to be developer friendly.
-   [gorp](https://github.com/go-gorp/gorp) <span> ★ 2039, updated 1 days ago </span> - Go Relational Persistence, ORM-ish library for Go.
...
-   [Xorm](https://github.com/go-xorm/xorm) <span> ★ 1154, updated 1 days ago </span> - Simple and powerful ORM for Go.
...
-   [gigo](https://github.com/LyricalSecurity/gigo) <span> ★ 191, updated 20 days ago </span> - PIP-like dependency tool for golang, with support for private repositories and hashes.
-   [glide](https://github.com/Masterminds/glide) <span> ★ 1686, updated 1 days ago </span> - Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip.
-   [godep](https://github.com/tools/godep) <span> ★ 3355, updated 1 days ago </span> - dependency tool for go, godep helps build packages reproducibly by fixing their dependencies.
-   [gom](https://github.com/mattn/gom) <span> ★ 1076, updated 1 days ago </span> - Go Manager - bundle for go.
...
-   [gopm](https://github.com/gpmgo/gopm) <span> ★ 955, updated 4 days ago </span> - Go Package Manager
...
-   [go-bindata](https://github.com/jteeuwen/go-bindata) <span> ★ 1761, updated 0 days ago </span> - Package that converts any file into managable Go source code.
...
-   [go.rice](https://github.com/GeertJohan/go.rice) <span> ★ 702, updated 2 days ago </span> - go.rice is a Go package that makes working with resources such as html,js,css,images and templates very easy.
...
-   [ewma](https://github.com/VividCortex/ewma) <span> ★ 154, updated 18 days ago </span> - Exponentially-weighted moving averages
...
-   [goraph](https://github.com/gyuho/goraph) <span> ★ 208, updated 4 days ago </span> - A pure Go graph theory library(data structure, algorith visualization)
...
-   [stats](https://github.com/montanaflynn/stats) <span> ★ 585, updated 2 days ago </span> - A statistics package with common functions missing from the Golang standard library.
-   [streamtools](https://github.com/nytlabs/streamtools) <span> ★ 1273, updated 7 days ago </span> - general purpose, graphical tool for dealing with streams of data.
...
-   [acmetool](https://github.com/hlandau/acme) <span> ★ 751, updated 1 days ago </span> — ACME (Let's Encrypt) client tool with automatic renewal.
...
-   [lego](https://github.com/xenolf/lego) <span> ★ 1086, updated 3 days ago </span> - Pure Go ACME client library and CLI tool (for use with Let's Encrypt)
...
-   [gogoprotobuf](https://github.com/gogo/protobuf) <span> ★ 386, updated 0 days ago </span> - Protocol Buffers for Go with Gadgets
-   [goprotobuf](https://github.com/golang/protobuf) <span> ★ 860, updated 1 days ago </span> - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.
-   [mapstructure](https://github.com/mitchellh/mapstructure) <span> ★ 575, updated 1 days ago </span> - Go library for decoding generic map values into native Go structures.
...
-   [algernon](https://github.com/xyproto/algernon) <span> ★ 230, updated 6 days ago </span> - HTTP/2 web server with built-in support for Lua, Markdown, GCSS and Amber.
-   [Caddy](https://github.com/mholt/caddy) <span> ★ 5525, updated 0 days ago </span> - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.
-   [consul](https://www.consul.io/) - Consul is a tool for service discovery, monitoring and configuration.
-   [devd](https://github.com/cortesi/devd) <span> ★ 2061, updated 2 days ago </span> - A local webserver for developers
-   [etcd](https://github.com/coreos/etcd) <span> ★ 9299, updated 0 days ago </span> - A highly-available key value store for shared configuration and service discovery.
-   [minio](https://github.com/minio/minio) <span> ★ 1072, updated 1 days ago </span> - Minio is a distributed object storage server.
...
-   [mustache](https://github.com/hoisie/mustache) <span> ★ 788, updated 4 days ago </span> - A Go implementation of the Mustache template language.
-   [pongo2](https://github.com/flosch/pongo2) <span> ★ 701, updated 2 days ago </span> - A Django-like template-engine for Go.
...
-   Testing Frameworks
    ...
    -   [frisby](https://github.com/verdverm/frisby) <span> ★ 131, updated 1 days ago </span> - a REST API testing framework
    ...
    -   [gofight](https://github.com/appleboy/gofight) <span> ★ 26, updated 2 days ago </span> - API Handler Testing for Golang Router framework.
    ...
    -   [testfixtures](https://github.com/go-testfixtures/testfixtures) <span> ★ 2, updated 0 days ago </span> - A helper for Rails' like test fixtures to test database applications.
    -   [Testify](https://github.com/stretchr/testify) <span> ★ 1812, updated 1 days ago </span> - A sacred extension to the standard go testing package.
-   Mock
    ...
    -   [go-txdb](https://github.com/DATA-DOG/go-txdb) <span> ★ 4, updated 11 days ago </span> - Single transaction based database driver mainly for testing purposes.
...
-   Fuzzing and delta-debugging/reducing/shrinking
    ...
    -   [go-fuzz](https://github.com/dvyukov/go-fuzz) <span> ★ 1355, updated 3 days ago </span> <span> ★ 1355, updated 3 days ago </span> - A randomized testing system
...
-   Specific Formats
    ...
    -   [go-humanize](https://github.com/dustin/go-humanize) <span> ★ 671, updated 3 days ago </span> - Formatters for time, numbers, and memory size to human readable format.
    ...
    -   [gofeed](https://github.com/mmcdole/gofeed) <span> ★ 372, updated 0 days ago </span> - Parse RSS and Atom feeds in Go
    ...
    -   [toml](https://github.com/BurntSushi/toml) <span> ★ 842, updated 1 days ago </span> - TOML configuration format (encoder/decoder with reflection).
-   Utility
...
-   [aws-sdk-go](https://github.com/aws/aws-sdk-go) <span> ★ 2448, updated 1 days ago </span> - The official AWS SDK for the Go programming language.
...
-   [discordgo](https://github.com/bwmarrin/discordgo) <span> ★ 70, updated 2 days ago </span> - Go bindings for the Discord Chat API
...
-   [ghost](https://github.com/neuegram/ghost) <span> ★ 15, updated 1 days ago </span> - Go Library for accessing the Snapchat API.
-   [github](https://github.com/google/go-github) <span> ★ 1635, updated 1 days ago </span> - Go library for accessing the GitHub API.
...
-   [apm](https://github.com/topfreegames/apm) <span> ★ 32, updated 9 days ago </span> - A process manager for Golang applications with an HTTP API.
-   [boilr](https://github.com/tmrts/boilr) <span> ★ 46, updated 5 days ago </span> - A blazingly fast CLI tool for creating projects from boilerplate templates.
...
-   [coop](https://github.com/rakyll/coop) <span> ★ 1143, updated 2 days ago </span> - Cheat sheet for some of the common concurrent flows in Go.
...
-   [delve](https://github.com/derekparker/delve) <span> ★ 3484, updated 1 days ago </span> - Go debugger.
...
-   [filetype](https://github.com/h2non/filetype) <span> ★ 51, updated 25 days ago </span> - Small package to infer the file type checking the magic numbers signature.
-   [fzf](https://github.com/junegunn/fzf) <span> ★ 4667, updated 0 days ago </span> - A command-line fuzzy finder written in Go
...
-   [gentleman](https://github.com/h2non/gentleman) <span> ★ 261, updated 3 days ago </span> - Full-featured plugin-driven HTTP client library.
...
-   [godropbox](https://github.com/dropbox/godropbox) <span> ★ 3027, updated 0 days ago </span> - Common libraries for writing Go services/applications from Dropbox.
...
-   [grequests](https://github.com/levigross/grequests) <span> ★ 705, updated 7 days ago </span> - An elegant and simple `    net/http   ` wrapper that follows Python's requests library
-   [htcat](https://github.com/htcat/htcat) <span> ★ 416, updated 13 days ago </span> - Parallel and Pipelined HTTP GET Utility
-   [httpcontrol](https://github.com/facebookgo/httpcontrol) <span> ★ 407, updated 15 days ago </span> - Package httpcontrol allows for HTTP transport level control around timeouts and retries.
-   [hystrix-go](https://github.com/afex/hystrix-go) <span> ★ 380, updated 7 days ago </span> - Implements Hystrix patterns of programmer-defined fallbacks aka circuit breaker.
...
-   [mc](https://github.com/minio/mc) <span> ★ 215, updated 1 days ago </span> - Minio Client provides minimal tools to work with Amazon S3 compatible cloud storage and filesystems.
-   [mergo](https://github.com/imdario/mergo) <span> ★ 123, updated 2 days ago </span> - A helper to merge structs and maps in Golang. Useful for configuration default values, avoiding messy if-statements.
...
-   [multitick](https://github.com/VividCortex/multitick) <span> ★ 43, updated 165 days ago </span> - Multiplexor for aligned tickers.
-   [netbug](https://github.com/e-dard/netbug) <span> ★ 29, updated 20 days ago </span> - Easy remote profiling of your services.
-   [ngrok](https://github.com/inconshreveable/ngrok) <span> ★ 6895, updated 1 days ago </span> - Introspected tunnels to localhost.
-   [okrun](https://github.com/xta/okrun) <span> ★ 11, updated 33 days ago </span> - go run error steamroller.
-   [panicparse](https://github.com/maruel/panicparse) <span> ★ 1259, updated 2 days ago </span> - Groups similar goroutines and colorizes stack dump.
...
-   [sqlx](https://github.com/jmoiron/sqlx) <span> ★ 1700, updated 1 days ago </span> - provides a set of extensions on top of the excellent built-in database/sql package.
-   [ugo](https://github.com/alxrm/ugo) <span> ★ 7, updated 13 days ago </span> - ugo is slice toolbox with concise syntax for Go.
-   [xlsx](https://github.com/tealeg/xlsx) <span> ★ 948, updated 1 days ago </span> - Library to simplify reading the XML format used by recent version of Microsoft Excel in Go programs.
...
-   [goav](https://github.com/giorgisio/goav) <span> ★ 123, updated 10 days ago </span> - Comphrensive Go bindings for FFmpeg.
...
-   [Beego](https://github.com/astaxie/beego) <span> ★ 6815, updated 1 days ago </span> - beego is an open-source, high-performance web framework for the Go programming language.
...
-   [Echo](https://github.com/labstack/echo) <span> ★ 4113, updated 0 days ago </span> - A fast and unfancy micro web framework for Go.
-   [Gin](https://github.com/gin-gonic/gin) <span> ★ 6292, updated 0 days ago </span> - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.
-   [Gizmo](https://github.com/NYTimes/gizmo) <span> ★ 1342, updated 1 days ago </span> - Microservice toolkit used by the New York Times.
...
-   [go-json-rest](https://github.com/ant0ine/go-json-rest) <span> ★ 2277, updated 2 days ago </span> - A quick and easy way to setup a RESTful JSON API.
-   [go-kit](https://github.com/go-kit/kit) <span> ★ 3824, updated 1 days ago </span> - A Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.
...
-   [go-socket.io](https://github.com/googollee/go-socket.io) <span> ★ 1104, updated 1 days ago </span> - socket.io library for golang, a realtime application framework.
...
-   [Gondola](https://github.com/rainycape/gondola) <span> ★ 296, updated 14 days ago </span> - The web framework for writing faster sites, faster
...
-   [httprouter](https://github.com/julienschmidt/httprouter) <span> ★ 3049, updated 1 days ago </span> - A high performance router. Use this and the standard http handlers to form a very high performance web framework.
...
-   [Macaron](https://github.com/go-macaron/macaron) <span> ★ 1070, updated 1 days ago </span> - Macaron is a high productive and modular design web framework in Go.
...
-   [mux](https://github.com/gorilla/mux) <span> ★ 2251, updated 0 days ago </span> - A powerful URL router and dispatcher for golang.
-   [neo](https://github.com/ivpusic/neo) <span> ★ 249, updated 2 days ago </span> - Neo is minimal and fast Go Web Framework with extremely simple API.
...
-   [pat](https://github.com/bmizerany/pat) <span> ★ 937, updated 2 days ago </span> - Sinatra style pattern muxer for Go’s net/http library, by the author of Sinatra.
...
-   [Revel](https://github.com/revel/revel) <span> ★ 6636, updated 0 days ago </span> - A high-productivity web framework for the Go language.
...
-   [Siesta](https://github.com/VividCortex/siesta) <span> ★ 338, updated 13 days ago </span> - Composable framework to write middleware and handlers
...
-   [Volatile](https://github.com/volatile/core) <span> ★ 81, updated 62 days ago </span> - Minimalist middleware stack promoting flexibility, good practices and clean code.
...
-   [zeus](https://github.com/daryl/zeus) <span> ★ 93, updated 36 days ago </span> - A very simple and fast HTTP router for Go.
...
-   [errcheck](https://github.com/kisielk/errcheck) <span> ★ 551, updated 1 days ago </span> - Errcheck is a program for checking for unchecked errors in Go programs.
-   [gcvis](https://github.com/davecheney/gcvis) <span> ★ 509, updated 1 days ago </span> - Visualise Go program GC trace data in real time.
-   [Go Metalinter](https://github.com/alecthomas/gometalinter) <span> ★ 843, updated 0 days ago </span> - Metalinter is a tool to automatically apply all static analysis tool and report their output in normalized form.
...
-   [GoLint](https://github.com/golang/lint) <span> ★ 1307, updated 1 days ago </span> - Golint is a linter for Go source code.
...
-   [interfacer](https://github.com/mvdan/interfacer) <span> ★ 470, updated 2 days ago </span> - A linter that suggests interface types.
...
-   [go-lang-idea-plugin](https://github.com/go-lang-plugin-org/go-lang-idea-plugin) <span> ★ 3246, updated 1 days ago </span> Go plugin for IntelliJ IDEA.
-   [go-plus](https://github.com/joefitzgerald/go-plus) <span> ★ 842, updated 2 days ago </span> - Go (Golang) Package For Atom That Adds Autocomplete, Formatting, Syntax Checking, Linting and Vetting
-   [Goclipse](https://github.com/GoClipse/goclipse) <span> ★ 519, updated 1 days ago </span> - An Eclipse plugin for Go.
...
-   [GoSublime](https://github.com/DisposaBoy/GoSublime) <span> ★ 2187, updated 3 days ago </span> - A Golang plugin collection for the text editor SublimeText 2 providing code completion and other IDE-like features.
-   [velour](https://github.com/velour/velour) <span> ★ 13, updated 29 days ago </span> - An IRC client for the acme editor.
-   [vim-compiler-go](https://github.com/rjohnsondev/vim-compiler-go) <span> ★ 63, updated 6 days ago </span> - A Vim plugin to highlight syntax errors on save.
-   [vim-go](https://github.com/fatih/vim-go) <span> ★ 4602, updated 0 days ago </span> - Go development plugin for Vim.
...
-   [rts](https://github.com/galeone/rts) <span> ★ 98, updated 4 days ago </span> - RTS: response to struct. Generates Go structs from server responses.
...
-   [aptly](https://github.com/smira/aptly) <span> ★ 1034, updated 1 days ago </span> - aptly is a Debian repository management tool.
...
-   [Banshee](https://github.com/eleme/banshee) <span> ★ 213, updated 1 days ago </span> - Anomalies detection system for periodic metrics.
-   [Boom](https://github.com/rakyll/boom) <span> ★ 4157, updated 1 days ago </span> - Boom is a tiny program that sends some load to a web application.
-   [bosun](https://github.com/bosun-monitor/bosun) <span> ★ 1756, updated 1 days ago </span> - Time Series Alerting Framework.
...
-   [Go Metrics](https://github.com/rcrowley/go-metrics) <span> ★ 1158, updated 1 days ago </span> - Go port of Coda Hale's Metrics library: <https://github.com/codahale/metrics> .
...
-   [gox](https://github.com/mitchellh/gox) <span> ★ 1529, updated 2 days ago </span> - A dead simple, no frills Go cross compile tool.
...
-   [GVM](https://github.com/moovweb/gvm) <span> ★ 1943, updated 3 days ago </span> - GVM provides an interface to manage Go versions.
...
-   [kubernetes](https://github.com/kubernetes/kubernetes) <span> ★ 13904, updated 0 days ago </span> - Container Cluster Manager from Google.
...
-   [Packer](https://github.com/mitchellh/packer) <span> ★ 5220, updated 0 days ago </span> - Packer is a tool for creating identical machine images for multiple platforms from a single source configuration.
...
-   [s3gof3r](https://github.com/rlmcpherson/s3gof3r) <span> ★ 646, updated 1 days ago </span> - A small utility/library optimized for high speed transfer of large objects into and out of Amazon S3.
...
-   [Vegeta](https://github.com/tsenart/vegeta) <span> ★ 3699, updated 1 days ago </span> - HTTP load testing tool and library. It's over 9000!
-   [webhook](https://github.com/adnanh/webhook) <span> ★ 377, updated 4 days ago </span> - Tool which allows user to create HTTP endpoints (hooks) that execute commands on the server.
...
-   [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) <span> ★ 691, updated 1 days ago </span> - Go HTTP request router benchmark and comparison.
...
-   [GoBooks](https://github.com/dariubs/GoBooks) <span> ★ 2040, updated 0 days ago </span> - A curated list of Go books
...
-   [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) <span> ★ 5340, updated 1 days ago </span> - A curated list of awesome remote jobs. A lot of them is looking for Go hackers.
-   [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) <span> ★ 15994, updated 0 days ago </span> - List of other amazingly awesome lists.
...
-   [go-ole](https://github.com/go-ole/go-ole) <span> ★ 191, updated 2 days ago </span> - Win32 OLE implementation for golang.
